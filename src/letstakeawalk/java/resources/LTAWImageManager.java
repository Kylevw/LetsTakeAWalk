...
public class LTAWImageManager extends ImageManager implements ImageProviderIntf {
    ...
    public static final String WOMAN_WALK_UP_00 = "WOMAN_WALK_UP_00";
    public static final String WOMAN_WALK_UP_01 = "WOMAN_WALK_UP_01";
    public static final String WOMAN_WALK_UP_02 = "WOMAN_WALK_UP_02";
    ...
    public static final String WOMAN_WALK_LEFT_LIST = "WOMAN_WALK_LEFT_LIST";
...

    {
        ...
        WOMAN_IDLE_UP = new ArrayList<>();
        WOMAN_IDLE_DOWN = new ArrayList<>();
        WOMAN_IDLE_LEFT = new ArrayList<>();
        WOMAN_IDLE_RIGHT = new ArrayList<>();
        ...
        WOMAN_IDLE_UP.add(WOMAN_IDLE_UP_00);
        ...
        WOMAN_IDLE_LEFT.add(WOMAN_IDLE_LEFT_00);
        ...
        WOMAN_IDLE_RIGHT.add(WOMAN_IDLE_RIGHT_00);
        imageListMap.put(WOMAN_IDLE_RIGHT_LIST, WOMAN_IDLE_RIGHT);
    }
    ...
    public BufferedImage getImage(String name) {
        ...
        if (image == null) {
            image = (BufferedImage) im.getImage(MISSING_TEXTURE);
        }
        return image;
    }
